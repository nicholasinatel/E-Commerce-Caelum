<?php
    ...
    $cabecalho_css = '<link rel="stylesheet" href="assets/css/sobre.css">';
...
<body>
    <article>
        <section>
            <p>A <strong>Mirror Fashion</strong> é a maior empresa comércio eletrônico no segmento de moda em todo o mundo. Fundada
                em 1932, possui filiais em 124 países, sendo líder de mercado com mais de 90% de participação em 118 deles.</p>
            <p>Nosso centro de distribuição fica em
                <a href="https://maps.google.com.br/?q=Jacarezinho">Jacarezinho, no Paraná.</a>
                </a> De lá, saem 48 aviões que distribuem nossos produtos às casas do mundo todo. Nosso centro de distribuição:</p>
        </section>
        <section>
            <figure>
                <img id="centro-distribuicao" src="img/centro-distribuicao.png">
        ...
        <section>
            ...
            <figure id="familia-pelho">
                <img id="pelho-family" src="img/familia-pelho.jpg">
        ...
        <section>
            <p>A fundação em 1932 ocorreu no momento da descoberta econônica do interior do Paraná. A família
                ...
                <em>Eduardo Simões Pelho</em>, dotado de particular visão administrativa, guiou os negócios da empresa durante
                mais de 50 anos, muitos deles ao lado de seu filho
            ...
            <p>Dada a importância econômica da empresa para o Brasil, a família
                <em>Pelho</em> já recebeu diversos prêmios, homenagens e condecorações. Todos os presidentes do Brasil já visitaram
                as instalações da
                <strong>Mirror Fashion</strong>, além de presidentes da União Européia, Ásia e o secretário-geral da ONU.</p>
        </section>
        <section>
    ...
    <div id="mapa">
    <iframe id="vivaz"
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1848.1369965272434!2d-45.05473602803573!3d-22.115526697422595!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94cb4b946dac71ef%3A0xeac7d373df27d0d2!2sEdif%C3%ADcio+Cedro+do+L%C3%ADbano!5e0!3m2!1sen!2sbr!4v1537363532892" 
